...
//
//========================try...catch
// Конструкция try..catch позволяет обрабатывать ошибки во время исполнения кода.Она позволяет запустить код и 
// перехватить ошибки, которые могут в нём возникнуть.
//     Синтаксис:
// try {
//     // исполняем код
// } catch (err) {
...
//     вместо catch (err) {.
//         Мы можем также генерировать собственные ошибки, используя оператор throw.Аргументом throw может 
//         быть что угодно, но обычно это объект ошибки, наследуемый от встроенного класса Error.Подробнее 
//         о расширении ошибок см.в следующей главе.
